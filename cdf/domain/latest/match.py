...
class Status(TypedDict):
    ...
    has_extratime: bool  # Denotes whether the game went to extra time (true) or not (false)
    has_shootout: bool  # Denotes whether the game had a penalty shootout (true) or not (false)
...
class Result(TypedDict):
    ...
    first_half_extratime: NotRequired[FirstHalfExtratime]  # Required if has_extratime is true
    second_half_extratime: NotRequired[SecondHalfExtratime]  # Required if has_extratime is true
...
class Referee(TypedDict):
    ...
    official_type: NotRequired[str]  # The type of referee (e.g. video_assistant_referee, main_referee, assistant_referee or fourth_official
...
class Card(TypedDict):
    ...
    type: Literal['yellow_card', 'red_card', 'second_yellow_card']  # Type of card which can be yellow card, red card or second yellow card
...
class Player(TypedDict):
    ...
    position_group: NotRequired[Literal['GK', 'DF', 'MF', 'FW', 'SUB']]  # Position group acronym given according to the CDF-compatible groups
    ...
    is_captain: NotRequired[bool]  # Whether the player is a captain (true) or not (false)
    ...
    foot: NotRequired[Literal['left', 'right', 'both']]  # A player's dominant foot, which can take the values left, right or both
