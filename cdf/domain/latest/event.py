...
class Metrics(TypedDict):
    xg: NotRequired[float | None]  # Calculated xG value between [0,1]
    post_shot_xg: NotRequired[
        float | None
    ]  # Calculated post-shot xG value between [0,1]
    xpass: NotRequired[float | None]  # Calculated xPass value between [0,1]
    epv: NotRequired[float | None]  # Expected possession value between [-1,1]
...
class Event(TypedDict):
    ...
    sub_type: str | None  # Name of the event subtype
    is_successful: (
